...
public final class Launcher
{
    ...
    public static void main(final String[] args)
    {
        ...
        else if (EArgs.getMode() == EArgs.EMode.HELP)
        {
            ...
            l.info("  --port <PORT>                 The port number to auto connect to (if [--isAgent] flag is set). Default is {}.", Types.EPort.DEFAULT.i);
            ...
            l.info("  --difficulty <DIFFICULTY>     The difficulty of the agent (if [--isAgent] flag is set) (0 = Random, 1 = Q-Learning). Default is {}.", sep.view.clientcontroller.EClientInformation.DEFAULT_AGENT_DIFFICULTY);
                    ...
                    Types.EOS.isWindows()
                        ...
                        new ProcessBuilder(
                            ...
                            String.format(
                                ...
                                f,
                                "--isAgent",
                                !Objects.equals(EArgs.getCustomServerIP(), "") ? String.format("--addr %s", EArgs.getCustomServerIP()) : "",
                                EArgs.getCustomServerPort() != Types.EPort.INVALID.i ? String.format("--port %d", EArgs.getCustomServerPort()) : "",
